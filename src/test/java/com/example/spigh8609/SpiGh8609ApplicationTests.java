...
@SpringBootTest(classes = { SpiGh8609Application.class, SpiGh8609ApplicationTests.LocalContext.class })
@DirtiesContext
class SpiGh8609ApplicationTests {
  ...
  void connectAndReceive() throws IOException {
    ...
    try (Socket s = new Socket("localhost", 1234);
      ...
      // I will expect "abc21" but it is become "abc1"...
